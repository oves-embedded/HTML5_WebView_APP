...
public class FirstActivity extends AppCompatActivity {
    ...
    private static final String WEB_APP_URL = "https://wvapp.omnivoltaic.com/"; // Replace with your web app URL
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Initialize WebViewActivity immediately
        launchWebView();

        // Hide unused UI elements
        findViewById(R.id.etWebsite).setVisibility(View.GONE);
        findViewById(R.id.btnWebSite).setVisibility(View.GONE);
        findViewById(R.id.btnDemo).setVisibility(View.GONE);
    }

    private void launchWebView() {
        try {
            Intent intent = new Intent(FirstActivity.this, WebViewActivity.class);
            // Only set URL if it's not the default asset
            if (!WEB_APP_URL.equals("file:///android_asset/webview/index.html")) {
                intent.putExtra("url", WEB_APP_URL);
            }
            startActivity(intent);
            finish(); // Close FirstActivity since WebView will handle everything
        } catch (Exception e) {
            Log.e(TAG, "Error launching WebView: " + e.getMessage());
            Toast.makeText(this, "Error launching web app", Toast.LENGTH_SHORT).show();
        }
    }
